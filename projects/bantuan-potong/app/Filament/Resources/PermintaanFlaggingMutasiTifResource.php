...
use App\Filament\Resources\PermintaanFlaggingMutasiTifResource\Pages;
use Joaopaulolndev\FilamentPdfViewer\Forms\Components\PdfViewerField;
use App\Filament\Resources\PermintaanFlaggingMutasiTifResource\RelationManagers;
use Filament\Tables\Enums\FiltersLayout;

class PermintaanFlaggingMutasiTifResource extends Resource
{
    protected static ?string $model = PermintaanFlaggingMutasiTif::class;
    ...
    {
        return [
            'index' => Pages\ListPermintaanFlaggingMutasiTifs::route('/'),
            'create' => Pages\CreatePermintaanFlaggingMutasiTif::route('/create'),
            'view' => Pages\ViewPermintaanFlaggingMutasiTif::route('/{record}'),
            'edit' => Pages\EditPermintaanFlaggingMutasiTif::route('/{record}/edit'),
        ];
    }
}
