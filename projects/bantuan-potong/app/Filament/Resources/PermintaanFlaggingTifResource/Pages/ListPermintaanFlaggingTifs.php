...
use App\Exports\FlaggingExport;
...
class ListPermintaanFlaggingTifs extends ListRecords
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Actions\Action::make('exportFlaggingTif')
                ->label('Export Flagging TIF Data')
                ...
                ->action(function () {
                    ...
                    $filename = 'flagging' . now()->format('Ymd_His') . '.xlsx';

                    return Excel::download(new FlaggingExport($records), $filename);
                }),
        ];
    }
