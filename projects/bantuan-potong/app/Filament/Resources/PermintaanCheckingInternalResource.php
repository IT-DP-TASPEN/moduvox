...
use App\Filament\Resources\PermintaanCheckingInternalResource\Pages;
use Joaopaulolndev\FilamentPdfViewer\Forms\Components\PdfViewerField;
use App\Filament\Resources\PermintaanCheckingInternalResource\RelationManagers;

class PermintaanCheckingInternalResource extends Resource
{
    protected static ?string $model = PermintaanCheckingInternal::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-plus';
    protected static ?string $navigationGroup = 'Layanan Internal';
    protected static ?string $navigationLabel = 'Permintaan Cek';
    protected static ?string $pluralModelLabel = 'Permintaan Cek';
    protected static ?string $modelLabel = 'Permintaan Cek';
    ...
    public static function form(Form $form): Form
    {
        ...
        return $form
            ->schema([
                Forms\Components\Section::make('Detail Checking')
                    ->schema([
                ...
                Forms\Components\Section::make('Status')
                    ->schema([
                        ...
                        Forms\Components\Select::make('marketing_id')
                            ->label('Marketing')
                            ->options(function (?PermintaanCheckingInternal $record) {
                                $user = auth()->user();
        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('created_branch')
                    ...
                    ->multiple()
                    ->options(
                        PermintaanCheckingInternal::query()
                            ->select('created_branch')
                            ->whereNotNull('created_branch')
                            ->distinct()
                            ->orderBy('created_branch')
                ...
                Tables\Filters\SelectFilter::make('mitra_master_id')
                    ...
                    ->options(
                        \App\Models\MitraMaster::query()
                            ->whereIn(
                                'id',
                                PermintaanCheckingInternal::whereNotNull('mitra_master_id')
    ...
    {
        return [
            'index' => Pages\ListPermintaanCheckingInternals::route('/'),
            'create' => Pages\CreatePermintaanCheckingInternal::route('/create'),
            'view' => Pages\ViewPermintaanCheckingInternal::route('/{record}'),
            'edit' => Pages\EditPermintaanCheckingInternal::route('/{record}/edit'),
        ];
    }
}
