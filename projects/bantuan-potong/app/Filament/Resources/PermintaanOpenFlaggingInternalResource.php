...
use App\Filament\Resources\PermintaanOpenFlaggingInternalResource\Pages;
use App\Filament\Resources\PermintaanOpenFlaggingInternalResource\RelationManagers;

class PermintaanOpenFlaggingInternalResource extends Resource
{
    protected static ?string $model = PermintaanOpenFlaggingInternal::class;
                ...
                Forms\Components\Section::make('Status')
                    ->schema([
                        ...
                        Forms\Components\Select::make('marketing_id')
                            ->label('Marketing')
                            ->options(function (?PermintaanOpenFlaggingInternal $record) {
                                $user = auth()->user();
        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('created_branch')
                    ...
                    ->multiple()
                    ->options(
                        PermintaanOpenFlaggingInternal::query()
                            ->select('created_branch')
                            ->whereNotNull('created_branch')
                            ->distinct()
                            ->orderBy('created_branch')
                ...
                Tables\Filters\SelectFilter::make('mitra_master_id')
                    ...
                    ->options(
                        \App\Models\MitraMaster::query()
                            ->whereIn(
                                'id',
                                PermintaanOpenFlaggingInternal::whereNotNull('mitra_master_id')
    ...
    {
        return [
            'index' => Pages\ListPermintaanOpenFlaggingInternals::route('/'),
            'create' => Pages\CreatePermintaanOpenFlaggingInternal::route('/create'),
            'view' => Pages\ViewPermintaanOpenFlaggingInternal::route('/{record}'),
            'edit' => Pages\EditPermintaanOpenFlaggingInternal::route('/{record}/edit'),
        ];
    }
}
