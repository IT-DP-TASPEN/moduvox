...
class SavingAccountInternalExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents
{
    protected $records;
    ...
    public function headings(): array
    {
        return [
            ...
            'Detail Tujuan Pembukaan Rekening',
            'Kode Cabang',
            'Reference',
            'Nama Marketing',
            'Rekening Transfer',
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $row->wilayah,
            $row->savingProduct?->product_name ?? '',
            $row->saving_perpouse,
            $row->saving_perpouse_detail,
            $row->branch_code,
            $row->reference,
            $row->marketing?->marketing_name ?? '',
            $row->rek_transfer,
            $row->bank_transfer,
        ];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $textCols = ['B', 'D', 'F', 'R', 'S', 'V', 'W', 'X', 'Y', 'AD', 'AE', 'AF', 'AG','AQ','AR'];
