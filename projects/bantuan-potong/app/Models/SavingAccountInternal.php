...
class SavingAccountInternal extends Model
{
    protected $guarded = [];
    ...
    {
        return $this->belongsTo(ProductSavingMaster::class, 'saving_account_product');
    }

    public function savingPerpose()
    {
        return $this->belongsTo(AccountPerpouseMaster::class, 'saving_perpouse');
    }

    public function savingPerposeDetail()
    {
        return $this->belongsTo(AccountPerpouseDetail::class, 'saving_perpouse_detail');
    }
    ...
    public function accountPerpouseDetail()
    {
        return $this->belongsTo(AccountPerpouseDetail::class, 'saving_perpouse_detail');
    }
