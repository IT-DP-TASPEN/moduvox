...
return new class extends Migration
{
    ...
    {
        Schema::create('saving_account_internals', function (Blueprint $table) {
            $table->id();
            $table->foreignId('saving_account_product')->constrained('product_saving_masters')->cascadeOnDelete();
            $table->text('saving_perpouse');
            $table->text('saving_perpouse_detail');
    ...
    {
        Schema::dropIfExists('saving_account_internals');
    }
};
