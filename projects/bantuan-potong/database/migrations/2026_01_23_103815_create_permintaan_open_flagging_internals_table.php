...
return new class extends Migration
{
    ...
    {
        Schema::create('permintaan_open_flagging_internals', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('fee', 20, 2)->nullable(); // fee_checking
            $table->enum('status', [
    ...
    {
        Schema::dropIfExists('permintaan_open_flagging_internals');
    }
};
