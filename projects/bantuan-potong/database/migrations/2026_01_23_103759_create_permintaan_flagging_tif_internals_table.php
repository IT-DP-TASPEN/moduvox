...
return new class extends Migration
{
    ...
    {
        Schema::create('permintaan_flagging_tif_internals', function (Blueprint $table) {
            $table->id();
            $table->text('wilayah')->nullable();
            $table->enum('jenis_pensiun', ['pensiun', 'aktif'])->nullable();
            $table->enum('jenis_flagging', ['pensiun', 'tht', 'prapen', 'prapen_tht'])->nullable();
            ...
            $table->date('tanggal_bup')->nullable();
            $table->string('selisih_prapen')->nullable();
    ...
    {
        Schema::dropIfExists('permintaan_flagging_tif_internals');
    }
};
