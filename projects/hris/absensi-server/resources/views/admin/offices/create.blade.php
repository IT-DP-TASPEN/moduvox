...
@section('header', 'Tambah Kantor Baru')
...
<div class="max-w-4xl">
    <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
        <form action="{{ route('admin.offices.store') }}" method="POST" class="p-8 space-y-6">
            @csrf
            
            <div class="grid grid-cols-2 gap-6">
                <div class="space-y-2">
                    <label class="text-sm font-bold text-slate-700">Kode Kantor</label>
                    <input type="text" name="code" value="{{ old('code') }}" placeholder="Contoh: KP, KC-01" 
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Kantor Pusat"
                        class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-brand-blue focus:border-transparent transition-all" required>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <p class="text-[11px] text-slate-400">Klik pada peta untuk menentukan titik koordinat kantor.</p>
            </div>
            ...
            <div class="space-y-2">
                ...
                <textarea id="address" name="address" rows="3" 
                    ...
                    placeholder="Alamat akan terisi otomatis saat memilih lokasi di peta..." required>{{ old('address') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" id="lat" name="latitude" value="{{ old('latitude', -6.175392) }}"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="lng" name="longitude" value="{{ old('longitude', 106.827153) }}"
                        class="w-full px-6 py-4 rounded-2xl bg-slate-100 border-none font-bold text-slate-500 cursor-not-allowed" readonly required>
                </div>
                <div class="space-y-2">
            ...
            <script>
                ...
                function initMap() {
                    const lat = {{ old('latitude', -6.175392) }};
                    const lng = {{ old('longitude', 106.827153) }};
                    const rad = {{ old('radius', 100) }};
