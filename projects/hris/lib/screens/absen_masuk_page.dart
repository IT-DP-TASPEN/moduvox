...
class _AbsenMasukPageState extends State<AbsenMasukPage> {
  ...
  Future<void> _pickImage() async {
    ...
    if (pickedFile != null) {
      ...
      // Server saat ini default max 10MB; beri buffer kecil.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Absen Masuk", style: TextStyle(color: Colors.white)),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: Icon(Icons.watch_later, color: cs.primary, size: 20),
                              ),
