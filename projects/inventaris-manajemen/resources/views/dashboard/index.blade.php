...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="card-premium flex items-start gap-5 hover:-translate-y-1">
        ...
        <div>
            ...
            <h3 class="text-xl font-bold text-gray-900 tracking-tight">{{ \App\Helpers\FormatHelper::rupiah($totalPerolehan) }}</h3>
        </div>
    </div>
    ...
    <div class="card-premium flex items-start gap-5 hover:-translate-y-1">
        ...
        <div>
            ...
            <h3 class="text-xl font-bold text-gray-900 tracking-tight">{{ \App\Helpers\FormatHelper::rupiah($totalAkumulasi) }}</h3>
        </div>
    </div>
    ...
    <div class="card-premium flex items-start gap-5 hover:-translate-y-1">
        ...
        <div>
            ...
            <h3 class="text-xl font-bold text-gray-900 tracking-tight">{{ \App\Helpers\FormatHelper::rupiah($totalBuku) }}</h3>
        </div>
    </div>
</div>
