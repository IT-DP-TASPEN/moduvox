...
@if($is_excel)
    <table>
        ...
        <tr>
            <td colspan="11" style="text-align: center; font-weight: bold; font-size: 12px;">RINCIAN NOMINATIF AKTIVA TETAP DAN INVENTARIS</td>
        </tr>
        <tr>
...
@else
    ...
    <div class="report-title">
        RINCIAN NOMINATIF AKTIVA TETAP DAN INVENTARIS<br>
...
@endif
    ...
    <table>
        ...
        <tbody>
            ...
            @forelse($groupedData as $golonganName => $items)
