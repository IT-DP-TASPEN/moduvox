...
@section('title', 'Laporan Rincian Nominatif')
@section('page-title', 'Laporan Rincian Nominatif Aset')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-2xl mx-auto">
    <div class="mb-6 border-b border-gray-100 pb-4 flex items-center gap-4">
        ...
        <div>
            <h3 class="text-lg font-semibold text-gray-800">Cetak Laporan Rincian Nominatif</h3>
            <p class="text-sm text-gray-500">Pilih periode dan cabang untuk mencetak rincian aktiva tetap.</p>
        </div>
    </div>

    <form action="{{ route('reports.nominatif.generate') }}" method="GET" target="_blank">
        <div class="space-y-6">
